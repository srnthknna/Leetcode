...
class Solution {
    public List<Integer> boundaryOfBinaryTree(TreeNode root) {
        ...
        // Print Leaf;
        printLeaf(root, result, cacheRoot);
    ...
    private void printLeaf(TreeNode root, List<Integer> result, TreeNode cacheRoot) {
        if (root == null) return;
        printLeaf(root.left, result, cacheRoot);
        if (root.left == null && root.right == null && root != cacheRoot) {
            result.add(root.val);
            return;
        }
        printLeaf(root.right, result, cacheRoot);
    }
