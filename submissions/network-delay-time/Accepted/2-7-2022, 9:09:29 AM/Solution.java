...
class Solution {
    // Read dikstra from https://www.youtube.com/watch?v=pLElbKBc4RU&ab_channel=ShiranAfergan
    // And read solution from solution tab for this question this is ok question where we dont need to maintain the prev vector along with the visited
